  ...
  <form method="POST" action="/clients">
    ...
    <div id="identite">
      ...
      <div class="coordonner">
        ...
        Téléphone :<input type="tel" placeholder="+XXX XX XX XX XX" pattern="[0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}" id="Telephone"/>
        <br>
        ...
        <div id="mandataire" hidden>
          Nom et qualité du mandataire/représentant:<input type="text" placeholder="......................." id="Nom_du_mandataire"/></br>
          Qualité du mandataire/représentant:<input type="text" placeholder="......................." id="Qualite_du_mandataire"/></div>
        </br>
        Piece d'identité :
    ...
    <table>
      ...
      <tr>
        ...
        <th width="250px" height="25px"><input type="text" name="Quartier" placeholder="..........." id="Quartier"/></th>
      </tr>
      <tr>
        <th class="text-left" width="400px" height="5px">Carré du lot :<input type="text" placeholder="..........." id="Carre_du_lot"/>
        </th>
        <th class="text-left" width="250px" height="5px">Parcelle :<input type="text" placeholder="..........." id="Parcelle"/></th>
        <th class="text-left" width="250px" height="5px">Boite postale :<input type="text" placeholder="..........." id="Boite_Postale"/>
        </th>
      </tr>
      <tr>
        <th class="text-left" width="300px" height="5px">Coordonnées géographiques (GPS) :<input type="text" id="GPS" /> </th>
