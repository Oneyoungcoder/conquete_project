  ...
  <form method="POST" action="azert.php">
    ...
    <div id="identite">
      ...
      <div class="coordonner">
       ...
       Téléphone :<input type="tel" placeholder="+XXX XX XX XX XX"
          pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" required /> <br>
          Email :<input type="email"
          placeholder="........................................" required /></br>
        Boîte Postale :<input type="text"
          placeholder="..................................................................." required /></br>
        Adresse :<input type="text" placeholder="........................................." required /></br>
      ...
      <div id="the_click">
        ...
        <input type="radio" name="ori" id="ori" value="Abonne" required />
      ...
      <div class="cadre2"> <U><strong class="fine">TYPE D'OFFRES FTTx</strong></U> <strong>Double play(Téléphone +
          Internet)</strong>
        <input type="radio" name="offre" id="offre" required />
        ...
        <div id="Résidentiels" hidden>
          ...
          <input type="radio" name="particulier" id="offre" value="ADSL 04 Mbps" required />
        ...
        <div id="PetitesetMoyenesEntreprises" hidden>
          ...
          <input type="radio" name="moyennes" id="offre" value="ADSL 10 Mbps" required />
    ...
    <table>
      ...
      <tr>
        ...
        <th width="250px" height="25px"><input type="text" name="Quartier" placeholder="..........." required /></th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <th class="text-left" colspan="2" width="750px" height="10px">longitude<input type="text"
          ...
          latitude<input type="text" placeholder="..........." required />
        </th>
      </tr>
      <tr>
        <th class="text-left" width="300px" height="5px">Bâtiment :<input type="text" required /></th>
        <th class="text-left" width="300px" height="5px">Etage :<input type="text" required /></th>
        <th class="text-left" width="300px" height="5px">Porte :<input type="text" required /></th>
      </tr>
    </table>
    </p></br>
    ...
    <p class="text-10xl">Bénéficiez-vous d'une exonération fiscale ?
      <input type="radio" name="remplir" id="remplir" required />
    ...
    <p align="right" class="sign">Fait à:<input type="text" placeholder=".................." required />le
