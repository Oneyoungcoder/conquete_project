...
<body>
    <form method="POST" action="/physiques">
    @csrf
    <!-- <div class="im">
        ...
        <div class="coordonner">
            ...
            placeholder="......................." id="Nom_du_mandataire" name="Nom_du_mandataire" /></br>
            Qualité du mandataire/représentant:<input type="text"
            placeholder="......................." id="Qualité_du_mandataire" name="Qualité_du_mandataire" /></br>
        </div>
